                                     ...
                                     int Num_Internal_Tensor_in)
{
    ...
    if (Num_Material_Constant_in > 0)
    {
        ...
        {
            cerr << "MaterialConstant::Insufficient memory! \n";
            exit (1);
        }
    ...
    if (Num_Internal_Scalar_in > 0)
    {
        ...
        if (!Internal_Scalar)
        {
            cerr << "MaterialParameter::Insufficient memory! \n";
            exit (1);
        }
...
double MaterialParameter::getMaterial_Constant(int which) const
{
    ...
    {
        cerr << "Error! MaterialParameter::getMaterial_Constant - Invalid index of material constants. \n";
        exit(1);
    }
...
double MaterialParameter::getInternal_Scalar(int which) const
{
    ...
    {
        cerr << "Error! MaterialParameter::getInternal_Scalar - Invalid index of internal scalars. \n";
        exit(1);
    }
...
const stresstensor& MaterialParameter::getInternal_Tensor(int which) const
{
    ...
    {
        cerr << "Error! MaterialParameter::getInternal_Tensor - Invalid index of internal tensors. \n";
        exit (1);
    }
...
int MaterialParameter::setMaterial_Constant(int which, double newMaterial_Constant)
{
    if (which < 0 || which > Num_Material_Constant)
    {
        cerr << "Error! MaterialParameter::setMaterial_Constant - Invalid index of material constants. \n";
        return (1);
    }
...
int MaterialParameter::setInternal_Scalar(int which, double newInternal_Scalar)
{
    if (which < 0 || which > Num_Internal_Scalar)
    {
        cerr << "Error! MaterialParameter::setInternal_Scalar - Invalid index of internal scalars. \n";
        exit (1);
    }
...
int MaterialParameter::setInternal_Tensor(int which, const stresstensor& newInternal_Tensor)
{
    if (which < 0 || which > Num_Internal_Tensor)
    {
        cerr << "Error! MaterialParameter::setInternal_Tensor - Invalid index of internal tensors. \n";
        exit (1);
    }
