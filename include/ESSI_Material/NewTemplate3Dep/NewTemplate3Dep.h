...
class NewTemplate3Dep : public NDMaterial
{
    ...
    public:
        ...
        int setTrialStrain(const BJtensor& v, const BJtensor& r);
        int setTrialStrainIncr(const BJtensor& v);
        int setTrialStrainIncr(const BJtensor& v, const BJtensor& r);
    ...
    private:
        ...
        int Tensor2MatrixSysR4(const BJtensor& T, Matrix& M);


        //! Tensor2VectorSysR2:

        int Tensor2VectorSysR2(const BJtensor& T, Vector& V);


        //! Matrix2TensorSysR4:

        int Matrix2TensorSysR4(const Matrix& M, BJtensor& T);


        //! Vector2TensorSysR2:

        int Vector2TensorSysR2(const Vector& V, BJtensor& T, int Num0 = 0);
    ...
    public: // temp, for test only, to be deleted
        ...
        int Stiffness2Compliance(const BJtensor& S, BJtensor& C);
